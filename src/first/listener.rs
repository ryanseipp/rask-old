...
// use slab::Slab;
//
// use crate::first::sessions::Session;
//
...
//     workers_rx: Receiver<Arc<Session>>,
// }
//
// impl Listener {
//     /// TODO
//     pub fn new(tx: Vec<Sender<Arc<Session>>>, rx: Receiver<Arc<Session>>) -> Self {
...
//                 if self.workers_tx[self.last_worker]
//                     .send(session.clone())
//                     .is_ok()
//                 {
//                     return Ok(());
//                 }
//                 self.last_worker = (self.last_worker + 1) % self.workers_tx.len();
//                 Err(Error::new(
//                     ErrorKind::Other,
...
//             }
//
//             while let Ok(_session) = self.workers_rx.try_recv() {}
//         }
//     }
// }
